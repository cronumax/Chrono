          ...
          Swal.fire({
            ...
            if (res2.isConfirmed) {
              ...
              Swal.fire({
                title: 'Custom',
                icon: 'question',
                html: "<p>Every</p><select id='minIntervalNum' data-placeholder='Interval number'></select><select id='hrIntervalNum' data-placeholder='Interval number'></select><select id='dayIntervalNum' data-placeholder='Interval number'></select><select id='wkIntervalNum' data-placeholder='Interval number'></select><select id='moIntervalNum' data-placeholder='Interval number'></select><select id='yrIntervalNum' data-placeholder='Interval number'></select><select id='intervalUnit' data-placeholder='Interval unit'></select><select id='wkSettings' data-placeholder='Repeat on'></select><div class='flight-types'><input type='radio' name='flight-type' value='coach' id='coach'><label for='coach'>Coach</label><input type='radio' name='flight-type' value='business' id='business' checked><label for='business'>Business</label><input type='radio' name='flight-type' value='first' id='first'><label for='first'>First</label></div><select id='ends' data-placeholder='Ends'></select>",
                didOpen: function() {
                  var intervalUnits = {
                    'min': 'minute',
                    'hr': 'hour',
